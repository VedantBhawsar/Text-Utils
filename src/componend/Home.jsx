...
const Home = (props) => {
    ...
    return (
        <div>
            <Alert alert={props.alert} hidden />
            <div className="container" style={{ color: props.dark === 'light' ? 'black' : 'white' }}>
                ...
                <div className="container mt-3" style={{ color: props.dark === 'light' ? 'black' : 'white' }}>
                    <textarea className="form-control overflow-auto" rows="8" value={props.Text} onChange={props.Textchange} placeholder='Enter Text Here' style={{ backgroundColor: props.dark === 'light' ? 'white' : '#343a40', color: props.dark === 'light' ? 'black' : 'white' }} ></textarea>
                </div>
                <div className='my-3'>
                    ...
                    <button className="btn btn-primary my-1 mx-2" onClick={props.Capitalize}>Capitalize</button>
